...
RSpec.describe CucumberDashboard::Models::Scenario do
  context 'with a json string' do
    let(:json_string) { '{ "FeatureName":"RspecFeature", "FileName":"scenario_spec.rb", "Name":"RspecTest", "RelativePath":"cucumber_dashboard/spec/cucumber_dashboard/models/", "StepCount":"10", "Tags":["@rspec", "@test", "@cucumber"]  }' }
